...
dest_bucket_base = ec2utils.get'-bigdata-warehousing-'
...
dest_list =  get_s3_folders(startAfter="",bucket=dest_bucket)
src_list = get_s3_folders(startAfter="",bucket=src_bucket)

dest_list = deduplicate_list(dest_list)
src_list = deduplicate_list(src_list)

delta_list = diff(src_list,dest_list)
